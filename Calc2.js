    ...
    button.onclick = function (){
        ...
        if (Qtde <= 0) {
            ...
            if (CB == CC || CA > CB && CA > CC){
                document.getElementById("conteudo").innerHTML="Você selecionou " + Qtde + " livros!" + " No Criterio A, o desconto obtido na compra de " + Qtde + " livros é de R$ " + CA;
            ...
            if (CA == CC || CB > CA && CB > CC){
                document.getElementById("conteudo").innerHTML="Você selecionou " + Qtde + " livros!" + " No Criterio B, o desconto obtido na compra de " + Qtde + " livros é de R$ " + CB;
                localStorage.setItem("B", CB);
                document.getElementById("conteudo").innerHTML = "Você selecionou " + Qtde + " livros!" + " No Criterio B, o desconto obtido na compra de " + Qtde + " livros é de R$ " + CB;
                document.getElementById("cupom").addEventListener("click", myFunction);
            }
            if (CA == CB || CC > CA && CC > CB){
                document.getElementById("conteudo").innerHTML="Você selecionou " + Qtde + " livros!" + " No Criterio C, o desconto obtido na compra de " + Qtde + " livros é de R$ " + CC;
